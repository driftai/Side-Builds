...
async def run_surface_combinations_e2e():
    ...
    assert slot1.last_state["buttons"]["DPAD_UP"] is True
    assert slot1.last_state["buttons"]["DPAD_LEFT"] is True
    ...
    print("  [PASS] Combination A: Remote Keyboard Surface -> Xbox 360 Output (WASD/U/I/Shift/Space/Esc mapped)")
