...
// Keyboard types share a canonical shape, then apply only the physical-key
// differences. Controller label presets never replace the keyboard geometry.
KEYBOARD_LAYOUTS.compact_arrowless = KEYBOARD_LAYOUTS.compact_60.map(row =>
  row.filter(key => key.spacer || !String(key.code || "").startsWith("Arrow"))
);
...
const CONTROLLER_BADGES = {
  xbox_controller: {
    ...
    "ShiftLeft": { badge: "LT", highlight: "vk-highlight-modifier" },
    "ShiftRight": { badge: "LT", highlight: "vk-highlight-modifier" },
    "ControlLeft": { badge: "RT", highlight: "vk-highlight-modifier" },
    "ControlRight": { badge: "RT", highlight: "vk-highlight-modifier" },
    "KeyZ": { badge: "LB", highlight: "vk-highlight-modifier" },
    "KeyC": { badge: "RB", highlight: "vk-highlight-modifier" },
    "Escape": { badge: "BACK", highlight: "vk-highlight-action" },
    "Enter": { badge: "START", highlight: "vk-highlight-action" },
    "F1": { badge: "GUIDE", highlight: "vk-highlight-action" },
  ...
  playstation_controller: {
    ...
    "KeyS": { badge: "LS ↓", highlight: "vk-highlight-move" },
    "KeyD": { badge: "LS →", highlight: "vk-highlight-move" },
    "Space": { badge: "✕", highlight: "vk-highlight-action" },
    "KeyE": { badge: "□", highlight: "vk-highlight-action" },
    "KeyQ": { badge: "△", highlight: "vk-highlight-action" },
    "KeyR": { badge: "○", highlight: "vk-highlight-action" },
    "ShiftLeft": { badge: "L2", highlight: "vk-highlight-modifier" },
    "ShiftRight": { badge: "L2", highlight: "vk-highlight-modifier" },
    "ControlLeft": { badge: "R2", highlight: "vk-highlight-modifier" },
    "ControlRight": { badge: "R2", highlight: "vk-highlight-modifier" },
    "KeyZ": { badge: "L1", highlight: "vk-highlight-modifier" },
    "KeyC": { badge: "R1", highlight: "vk-highlight-modifier" },
    "Escape": { badge: "SHARE", highlight: "vk-highlight-action" },
    "Enter": { badge: "OPTIONS", highlight: "vk-highlight-action" },
    "F1": { badge: "PS", highlight: "vk-highlight-action" },
    "CapsLock": { badge: "L3", highlight: "vk-highlight-action" },
    "KeyF": { badge: "L3", highlight: "vk-highlight-action" },
    "KeyG": { badge: "R3", highlight: "vk-highlight-action" },
    "ArrowUp": { badge: "RS ↑", highlight: "vk-highlight-move" },
