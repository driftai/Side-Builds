...
export default function Header() {
  ...
  const getViewLabel = () => {
    ...
    switch (mainTab) {
      ...
      case 'unidex-log': return 'Unidex Log';
          ...
          <div className="header-menu-wrapper" ref={viewMenuRef}>
            ...
            >
              <div className="trigger-icon mobile-only">
                ...
                {mainTab === 'workspace' && <Boxes size={16} />}
                {mainTab === 'transcript' && <MessageSquare size={16} />}
                {mainTab === 'unidex-log' && <ListTree size={16} />}
            ...
            {showViewMenu && (
              <div className="header-dropdown-menu">
                ...
                <button
                  className={c('menu-item', { active: mainTab === 'workspace' })}
                  onClick={() => {
                ...
                <button
                  className={c('menu-item', { active: mainTab === 'unidex-log' })}
                  onClick={() => {
                    setMainTab('unidex-log');
                    setShowViewMenu(false);
                  }}
                >
                  <ListTree size={16} />
                  <span>Unidex Log</span>
                </button>
                <button 
