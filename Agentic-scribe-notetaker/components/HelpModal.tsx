      ...
      <div className="help-modal-content">
        ...
        <div className="help-section">
          ...
          <ul>
            ...
            <li>
              <strong>Add Diagrams & Graphs:</strong> When image generation is enabled
              in Settings, you can ask the scribe for illustrations or diagrams.
              You can always ask for <strong> mathematical graphs</strong> (e.g.,
